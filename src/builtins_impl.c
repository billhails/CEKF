...
Value builtin_rand(Vec *args) { return nrand(args->entries[0]); }
...
Value builtin_real_part(Vec *args) { return real_part(args->entries[0]); }

Value builtin_imag_part(Vec *args) { return imag_part(args->entries[0]); }

Value builtin_mag_part(Vec *args) { return mag_part(args->entries[0]); }

Value builtin_theta_part(Vec *args) { return theta_part(args->entries[0]); }
...
Value builtin_unicode_category(Vec *args) {
    ...
    case GC_Ll:
        return value_Stdint(GC_LL);
    case GC_Lm:
        return value_Stdint(GC_LM);
    case GC_Lo:
        return value_Stdint(GC_LO);
    case GC_Lt:
        return value_Stdint(GC_LT);
    case GC_Lu:
        return value_Stdint(GC_LU);
    case GC_Mc:
        return value_Stdint(GC_MC);
    case GC_Me:
        return value_Stdint(GC_ME);
    case GC_Mn:
        return value_Stdint(GC_MN);
    case GC_Nd:
        return value_Stdint(GC_ND);
    case GC_Nl:
        return value_Stdint(GC_NL);
    case GC_No:
        return value_Stdint(GC_NO);
    case GC_Pc:
        return value_Stdint(GC_PC);
    case GC_Pd:
        return value_Stdint(GC_PD);
    case GC_Pe:
        return value_Stdint(GC_PE);
    case GC_Pf:
        return value_Stdint(GC_PF);
    case GC_Pi:
        return value_Stdint(GC_PI);
    case GC_Po:
        return value_Stdint(GC_PO);
    case GC_Ps:
        return value_Stdint(GC_PS);
    case GC_Sc:
        return value_Stdint(GC_SC);
    case GC_Sk:
        return value_Stdint(GC_SK);
    case GC_Sm:
        return value_Stdint(GC_SM);
    case GC_So:
        return value_Stdint(GC_SO);
    case GC_Zl:
        return value_Stdint(GC_ZL);
    case GC_Zp:
        return value_Stdint(GC_ZP);
    case GC_Zs:
        return value_Stdint(GC_ZS);
    case GC_Cc:
        return value_Stdint(GC_CC);
    case GC_Cf:
        return value_Stdint(GC_CF);
    case GC_Co:
        return value_Stdint(GC_CO);
    case GC_Cs:
        return value_Stdint(GC_CS);
    case GC_Cn:
        return value_Stdint(GC_CN);
    default:
...
Value builtin_chr(Vec *args) {
    ...
    if (args->entries[0].type != VALUE_TYPE_STDINT) {
        cant_happen("unsupported numeric type for chr: %s",
                    valueTypeName(args->entries[0].type));
    }
#endif
...
#ifdef SAFETY_CHECKS
    if (args->entries[0].type != VALUE_TYPE_STDINT) {
        cant_happen("unsupported argument for args: %s",
                    valueTypeName(args->entries[0].type));
    }
#endif

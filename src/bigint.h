...
static inline BigInt *bigIntFromSubtraction(int a, int b) {
    return bigIntFromAddition(a, -b);
}
...
static inline Cmp cmpIntBigInt(int a, BigInt *b) {
    return (Cmp)(cmpBigIntInt(b, a) * -1);
}
static inline Cmp cmpDoubleBigInt(Double a, BigInt *b) {
    return (Cmp)(cmpBigIntDouble(b, a) * -1);
}
...
static inline BigInt *subBigIntInt(BigInt *a, int b) {
    return addBigIntInt(a, -b);
}
...
static inline bool isNegBigInt(BigInt *b) { return b->bi.neg != 0; }

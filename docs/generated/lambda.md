...
LamData --amb--> LamAmb
LamData --apply--> LamApply
LamData --back--> void_ptr
...
LamData --constructor--> LamTypeConstructorInfo
LamData --deconstruct--> LamDeconstruct
LamData --env--> void_ptr
LamData --error--> void_ptr
LamData --iff--> LamIff
LamData --lam--> LamLam
LamData --let--> LamLet
LamData --letrec--> LamLetRec
LamData --lookup--> LamLookup
LamData --make_tuple--> LamArgs
LamData --makeVec--> LamMakeVec
LamData --match--> LamMatch
LamData --namespaces--> LamNamespaceArray
LamData --prim--> LamPrimApp
LamData --print--> LamPrint
LamData --sequence--> LamSequence
LamData --stdint--> int
LamData --tag--> LamExp
LamData --tuple_index--> LamTupleIndex
LamData --typedefs--> LamTypeDefs
LamData --typeOf--> LamTypeof
LamData --var--> HashSymbol
LamData --args--> LamArgs
LamData --kont--> LamKont
LamData --exp--> LamExp

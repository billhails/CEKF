...
This document now primarily records the delivered phase-1 model described in
[SYNTAX.md](SYNTAX.md).

The dedicated working document for syntax import and export is
[SYNTAX_IMPORT_EXPORT_PLAN.md](SYNTAX_IMPORT_EXPORT_PLAN.md).
...
The dedicated working document for this follow-on is
[SYNTAX_IMPORT_EXPORT_PLAN.md](SYNTAX_IMPORT_EXPORT_PLAN.md).
